-- =====================================================================
-- UNIFIED REPAIR SCRIPT: AVAAT DESIGN SYSTEM DATABASE
-- Run this in the Supabase SQL Editor for active project: znednuexxtwcoesygzlo
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- Drop existing activity_logs to resolve column mismatches if any partial table exists
...
DECLARE
  ...
  v_email     TEXT;
BEGIN
  -- Safely extract user metadata or default
...
EXCEPTION WHEN OTHERS THEN
  -- Log but NEVER block the user signup transaction (crucial to prevent Auth 500 error)
  RAISE LOG 'handle_new_user error: %', SQLERRM;
  RETURN NEW;
END;
$$;

-- Drop trigger if exists, then bind to auth.users

...
async function test() {
  const testEmail = `test_active_${Date.now()}@gmail.com`;
  const testPassword = 'Password123!';
  const fullName = 'Test Active User';
  
  console.log(`Starting signup test with: ${testEmail} on active URL: ${supabaseUrl}`);
